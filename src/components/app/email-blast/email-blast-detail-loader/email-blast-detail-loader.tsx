...
import styles from "./email-blast-detail-loader.module.css";
  ...
  if (!blast) {
    return (
      <div className={styles.group}>
        <p className={styles.emptyText}>Blast tidak ditemukan</p>
        <p className={styles.emptytextP}>Data blast mungkin sudah dihapus atau ID tidak valid.</p>
        <Link href="/email-blast/history" className={cn(buttonVariants({ variant: "outline", size: "lg" }), styles.link)}>
          Kembali ke history
        </Link>
      </div>
    );
